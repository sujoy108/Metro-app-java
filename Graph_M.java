...
public class Graph_M {
  ...
  public static void Create_Metro_Map(Graph_M g) {
    g.addVertex("Noapara");
    g.addVertex("Netaji Subhas Chandra Bose International Airport");
    g.addVertex("Dum Dum");
    g.addVertex("Belgachhia");
    g.addVertex("Kolkata Railway Station");
    g.addVertex("Shyambazaar");
    g.addVertex("Shobhabazar Sutanuti");
    g.addVertex("Girish Park");
    g.addVertex("Mahatma Gandhi Road");
    g.addVertex("Central");
    g.addVertex("Chandni Chowk");
    g.addVertex("Esplanade");
    g.addVertex("Sealdah Railway Station");
    ...
    g.addVertex("Tollygunge Railway Station");
    g.addVertex("Mahanayak Uttam Kumar");
    g.addVertex("Netaji");
    g.addVertex("Masterda Surya Sen	");
    g.addVertex("Gitanjali");
    g.addVertex("Kavi Nazrul");
    g.addVertex("Shahid Khudiram");
    g.addVertex("Kavi Subhash");
    g.addVertex("New Garia Railway Station");

    g.addEdge("Noapara", "Netaji Subhas Chandra Bose International Airport", 8);
    g.addEdge("Noapara", "Dum Dum", 2);
    g.addEdge("Dum Dum", "Belgachhia", 2);
    g.addEdge("Belgachhia", "Kolkata Railway Station", 6);
    g.addEdge("Belgachhia", "Shyambazaar", 2);
    g.addEdge("Shyambazaar", "Shobhabazar Sutanuti", 1);
    g.addEdge("Shobhabazar Sutanuti", "Girish Park", 1);
    g.addEdge("Girish Park", "Mahatma Gandhi Road", 1);
    g.addEdge("Mahatma Gandhi Road", "Central", 1);
    g.addEdge("Central", "Chandni Chowk", 1);
    g.addEdge("Chandni Chowk", "Sealdah Railway Station", 2);
    ...
    g.addEdge("Netaji Bhavan", "Jatin Das Park", 2);
    g.addEdge("Jatin Das Park", "Kalighat", 1);
    g.addEdge("Kalighat", "Rabindra Sarobar", 2);
    g.addEdge("Rabindra Sarobar", "Tollygunge Railway Station", 3);
    g.addEdge("Rabindra Sarobar", "Mahanayak Uttam Kumar", 2);
    g.addEdge("Mahanayak Uttam Kumar", "Netaji", 2);
    g.addEdge("Netaji", "Masterda Surya Sen", 2);
    g.addEdge("Masterda Surya Sen", "Gitanjali", 2);
    g.addEdge("Gitanjali", "Kavi Nazrul", 2);
    g.addEdge("Kavi Nazrul", "Shahid Khudiram", 2);
    g.addEdge("Shahid Khudiram", "Kavi Subhash", 2);
    g.addEdge("Kavi Subhash", "New Garia Railway Station", 2);
  }
